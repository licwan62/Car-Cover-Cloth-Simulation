...
COLLISION_COLLECTION_NAME = "CC_COLLISION_PROXY"
...
for obj in objects:
    ...
    # Prefer the dedicated proxy collection generated by
    # generate_collision_proxy(.py|_standalone.py). If it does not exist,
    # None preserves Blender's default behavior of considering all colliders.
    collision.collection = bpy.data.collections.get(
